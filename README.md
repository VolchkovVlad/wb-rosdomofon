...
### Интеграция замка
1) Скачиваем шаблон для замка: ![Пример отображения конфигурационного файла](examples/SprutHub_lock.json)
Шаблон актуален для версии SH 1.12.8 Для более новых версий возможно потребуется обновить шаблон.
